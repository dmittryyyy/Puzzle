...
const RestartBlock = (props) =>
    <div className='restart-block'>
        <button className='restart__button' onClick={() => props.onInitGame(GameId_4x4)}>Restart 4x4</button>
        <button className='restart__button' onClick={() => props.onInitGame(GameId_5x5)}>Restart 5x5</button>
        <button className='restart__button' onClick={() => props.onInitGame(GameId_6x6)}>Restart 6x6</button>
        <button className='restart__button' onClick={() => props.onInitGame(GameId_7x7)}>Restart 7x7</button>
    </div>;
